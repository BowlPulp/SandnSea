...
const BrandMarquee = () => {
  // Replace these with your actual property developer logos
   const brandImages = [
    '/brands/AdaniViews.png',
    '/brands/DLF.png',
    '/brands/DLHSignature.png',
    '/brands/LodhaDivino.png',
    '/brands/GodrejReserve.png',
    '/brands/LodhaAltus.png',
    '/brands/PrestigeCity.png',
    '/brands/RahejaAmaltus.png',
    '/brands/LodhaAcenza.png',
    '/brands/RunwalAvenue.png',
    '/brands/VeenuaLuxecity.png',
    '/brands/LodhaBellagio.png',
  ];

...
const ClientsPage = () => {
  ...
  const testimonials = [
  {
    ...
    company: "Singer",
    role: "Self",
    image: "https://api.generated.photos/api/v1/faces?api_key=demo&age=young-adult&gender=female", // placeholder - replace with saved image if needed
  ...
  },
  {
    ...
    role: "COO",
    image: "https://fakeface.rest/face/view?minimum_age=30&gender=male", // AI-generated male
  ...
  },
  {
    ...
    image: "https://randomuser.me/api/portraits/men/32.jpg", // Not a real person — from RandomUser
